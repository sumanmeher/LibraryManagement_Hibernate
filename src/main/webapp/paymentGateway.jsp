    ...
    <div class="container">
      ...
      <div class="row justify-content-center"  >
        <div class="col-xl-6 col-lg-8">
          <h1>Payment Gateway<span>.</span></h1>
        </div>
      </div>
      ...
      <form action="paymentGateway">
		<input type="text" name="acc_no" placeholder="Account number" class="form form-control mt-3"><br>
		<input type="password" name="pin" placeholder="Enter Pin" class="form form-control"><br>
